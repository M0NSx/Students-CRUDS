...
def Étudiants():
    ...
    def delete_étudiants():
        try:
            ...
            messagebox.showinfo("Succès", "Vous avez supprimé l'étudiant avec succès!")
    ...
    bouton_supprimer2 = Button(frame_détails, command=delete_étudiants, anchor=CENTER, text="Supprimer".upper(), width=9, overrelief=RIDGE, font=("Ivy 7 bold"), bg=co7, fg=co1)
...
def Ajouter():
    ...
    def actualiser_classe():
        try:
            ...
            date_initiale.insert(0, tree_liste[3])
